import "./globals.css";
export const metadata = { title: "Top Gun Engineering · Maintenance Intelligence Delivered", description: "The ShiftForge deployment partner for mining and heavy industry." };
